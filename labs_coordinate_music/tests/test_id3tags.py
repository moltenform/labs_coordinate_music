...
class TestLengthAndBitrate:
    ...
    def test_getDurationFlacWithObj(self, fixture_getmedia):
        assert 1023 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'flac.flac'), CoordMusicAudioMetadata(join(fixture_getmedia, 'flac.flac'))
            )
        )
    ...
    def test_getDurationM4a16WithObj(self, fixture_getmedia):
        assert 1160 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'm4a16.m4a'), CoordMusicAudioMetadata(join(fixture_getmedia, 'm4a16.m4a'))
            )
        )
    ...
    def test_getDurationM4a128WithObj(self, fixture_getmedia):
        assert 1091 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'm4a128.m4a'), CoordMusicAudioMetadata(join(fixture_getmedia, 'm4a128.m4a'))
            )
        )
    ...
    def test_getDurationM4a224WithObj(self, fixture_getmedia):
        assert 1091 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'm4a224.m4a'), CoordMusicAudioMetadata(join(fixture_getmedia, 'm4a224.m4a'))
            )
        )
    ...
    def test_getDurationMp3Avg16WithObj(self, fixture_getmedia):
        assert 2773 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'mp3_avgb16.mp3'),
    ...
    def test_getDurationMp3Avg126WithObj(self, fixture_getmedia):
        assert 2773 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'mp3_avgb128.mp3'),
    ...
    def test_getDurationMp3Avg224WithObj(self, fixture_getmedia):
        assert 2773 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'mp3_avgb224.mp3'),
    ...
    def test_getDurationMp3Cns16WithObj(self, fixture_getmedia):
        assert 2873 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'mp3_cnsb16.mp3'),
    ...
    def test_getDurationMp3Cns128WithObj(self, fixture_getmedia):
        assert 2773 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'mp3_cnsb128.mp3'),
    ...
    def test_getDurationMp3Cns224WithObj(self, fixture_getmedia):
        assert 2773 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'mp3_cnsb224.mp3'),
    ...
    def test_getDurationOgg01WithObj(self, fixture_getmedia):
        assert 1591 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'ogg_01.ogg'), CoordMusicAudioMetadata(join(fixture_getmedia, 'ogg_01.ogg'))
            )
        )
    ...
    def test_getDurationOgg10WithObj(self, fixture_getmedia):
        assert 1591 == int(
            1000 * get_audio_duration(
                join(fixture_getmedia, 'ogg_10.ogg'), CoordMusicAudioMetadata(join(fixture_getmedia, 'ogg_10.ogg'))
            )
        )
...
class TestSettingTags:
    ...
    def test_id23DiffersFromId24(self, fixture_getmedia):
        ...
        o24.set('title', 'test')
        o24.save()
        assert files.computeHash(join(fixture_getmedia, 'id3',
                                      'id23.mp3')) != files.computeHash(join(fixture_getmedia, 'id3', 'id24.mp3'))
